            ...
            <div class="main-bottom">
                ...
                <div class="third-bottom-part">
                   ...
                   <div class="bottom-services">
                        ...
                        <nuxt-link :to="``" class="bottom-services-link">TV Subscription</nuxt-link>                            <nuxt-link :to="``" class="bottom-services-link">Exam Result</nuxt-link>
...
.bottom-services-link, .bottom-about-link{
    color:#383838;
}
.border-bottom{
    display: flex;
